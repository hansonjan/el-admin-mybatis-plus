 ...
 */
package com.admin.modules.quartz.rest;
...
public class QuartzJobController {
    ...
    public ResponseEntity<Object> query(JobQueryCriteria criteria, IPage pageable){
    ...
    @PreAuthorize("@el.check('timing:list')")
    public ResponseEntity<Object> queryJobLog(JobQueryCriteria criteria, IPage pageable){
