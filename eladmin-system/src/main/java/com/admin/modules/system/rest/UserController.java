 ...
 */
package com.admin.modules.system.rest;
...
import com.admin.modules.system.service.*;
...
public class UserController {
    ...
    @GetMapping
    @PreAuthorize("@el.check('user:list')")
    public ResponseEntity<Object> query(UserQueryCriteria criteria, IPage pageable){
