...
import com.admin.domain.vo.EmailVo;
import com.admin.exception.BadRequestException;
import com.admin.modules.system.service.VerifyService;
...
public class VerifyServiceImpl implements VerifyService {
    ...
    public EmailVo sendEmail(String email, String key) {
        ...
        if(oldCode == null){
            ...
            emailVo = new EmailVo(Collections.singletonList(email),"EL-ADMIN-MYBATIS-PLUS后台管理系统",content);
        // 存在就再次发送原来的验证码
        } else {
