...
import static com.admin.utils.FileUtil.SYS_TEM_DIR;
...
public class GenUtil {
    ...
    private static List<String> getAdminTemplateNames() {
        ...
        templateNames.add("MapStructMapper");
    ...
    private static String getAdminFilePath(String templateName, GenConfig genConfig, String className, String rootPath) {
        ...
        if ("MapStructMapper".equals(templateName)) {
            return packagePath + "service" + File.separator + "mapstruct" + File.separator +"MapStruct"+ className + "Mapper.java";
        }
